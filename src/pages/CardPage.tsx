...
import { Header, MainWrapper, MyLoader, PeopleCard, ShowInfo } from '../components';
                        ...
                        <div className="card__item">
                            ...
                            <div>
                                ...
                                <ul className='card__item-content'>
                                    ...
                                    <li className="card__item-descr">{`Birth year: ${cardPageData.birth_year}`}</li>
                                ...
                                <br />
                                <ShowInfo infoApiUrl={cardPageData.films} />
